...
.. note:: **プロキシの定義ついて**
    ...
    ただし、SOAPサーバが準備できない場合はスタブプロキシの作成とBean定義をdomainプロジェクトに追加し、スタブプロキシの切り替えについては
    `Spring Framework Reference Documentation -The IoC container(XML bean definition profiles)- <http://docs.spring.io/spring/docs/4.2.4.RELEASE/spring-framework-reference/html/beans.html#beans-definition-profiles>`_\を参照されたい。
