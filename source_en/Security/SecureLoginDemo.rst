...
* Must understand the contents of 
* Must understand the contents of 
* Must complete implementation of 
...
The application consists of following functions in addition to the application created in 
...
.. note::
   ...
   In this application, Lombok is used to eliminate boilerplate code. For Lombok, refer 
